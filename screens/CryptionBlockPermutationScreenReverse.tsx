...
export default function CryptionBlockPermutationReverseScreen({ navigation }: RootTabScreenProps<'CryptionSelectMenu'>) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Расшифрованный текст</Text>
