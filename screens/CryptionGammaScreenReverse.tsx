...
export default function CryptionGammaScreenReverse({ navigation }: RootTabScreenProps<'CryptionSelectMenu'>) {
  ...
  function Crypt(){
    let grid = Crypter.GammaReverse(wordBeforeCryption, key);
    //@ts-ignore
    let squareView = [];
